...
|-----|------|---------|-------------|
| dataSync.cpu.limit | int | `4` |  |
| dataSync.cpu.request | int | `2` |  |
| dataSync.ephemeralStorage.limit | string | `"10Gi"` |  |
| dataSync.ephemeralStorage.request | string | `"5Gi"` |  |
| dataSync.image | string | `"us-east1-docker.pkg.dev/runhouse-test/kubetorch-images/kubetorch-data-sync:v1"` |  |
| dataSync.imagePullPolicy | string | `"Always"` |  |
| dataSync.maxConnections | int | `500` |  |
| dataSync.maxConnectionsPerModule | int | `0` |  |
| dataSync.maxVerbosity | int | `0` |  |
| dataSync.memory.limit | string | `"8Gi"` |  |
| dataSync.memory.request | string | `"4Gi"` |  |
| dataSync.storage.size | string | `"100Gi"` |  |
| dataSync.storage.storageClassName | string | `""` |  |
| dataSync.timeout | int | `600` |  |
