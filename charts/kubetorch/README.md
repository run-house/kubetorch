...
| kubetorchController.ttl.podMonitor.additionalLabels | object | `{}` |  |
| kubetorchController.ttl.podMonitor.enabled | bool | `false` |  |
| kubetorchController.ttl.podMonitor.prometheusLabel | string | `"kube-prometheus"` |  |
| kubetorchController.ttl.prometheusUrl | string | `"http://kubetorch-metrics.kubetorch.svc.cluster.local:9090"` |  |
