...
| metrics.prometheus.additionalScrapeConfigs[0].job_name | string | `"kubernetes-pods"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].kubernetes_sd_configs[0].role | string | `"pod"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].relabel_configs[0].action | string | `"replace"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].relabel_configs[0].source_labels[0] | string | `"__meta_kubernetes_pod_label_kubetorch_com_service"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].relabel_configs[0].target_label | string | `"kubetorch_com_service"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].relabel_configs[1].source_labels[0] | string | `"__meta_kubernetes_namespace"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].relabel_configs[1].target_label | string | `"namespace"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].relabel_configs[2].source_labels[0] | string | `"__meta_kubernetes_pod_name"` |  |
| metrics.prometheus.additionalScrapeConfigs[0].relabel_configs[2].target_label | string | `"pod"` |  |
| metrics.prometheus.additionalScrapeConfigs[1].honor_labels | bool | `true` |  |
| metrics.prometheus.additionalScrapeConfigs[1].job_name | string | `"kubelet"` |  |
| metrics.prometheus.additionalScrapeConfigs[1].kubernetes_sd_configs[0].role | string | `"node"` |  |
| metrics.prometheus.additionalScrapeConfigs[1].relabel_configs[0].action | string | `"replace"` |  |
| metrics.prometheus.additionalScrapeConfigs[1].relabel_configs[0].source_labels[0] | string | `"__meta_kubernetes_node_label_kubetorch_com_service"` |  |
| metrics.prometheus.additionalScrapeConfigs[1].relabel_configs[0].target_label | string | `"kubetorch_com_service"` |  |
| metrics.prometheus.additionalScrapeConfigs[1].relabel_configs[1].source_labels[0] | string | `"__meta_kubernetes_node_name"` |  |
| metrics.prometheus.additionalScrapeConfigs[1].relabel_configs[1].target_label | string | `"node"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].honor_labels | bool | `true` |  |
| metrics.prometheus.additionalScrapeConfigs[2].job_name | string | `"gke-managed-dcgm"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].kubernetes_sd_configs[0].namespaces.names[0] | string | `"gke-managed-system"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].kubernetes_sd_configs[0].role | string | `"pod"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[0].action | string | `"replace"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[0].source_labels[0] | string | `"__meta_kubernetes_pod_label_kubetorch_com_service"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[0].target_label | string | `"kubetorch_com_service"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[1].action | string | `"keep"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[1].regex | string | `"dcgm-exporter.*"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[1].source_labels[0] | string | `"__meta_kubernetes_pod_name"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[2].action | string | `"keep"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[2].regex | string | `"9400"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[2].source_labels[0] | string | `"__meta_kubernetes_pod_container_port_number"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[3].replacement | string | `"$1:9400"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[3].source_labels[0] | string | `"__meta_kubernetes_pod_ip"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[3].target_label | string | `"__address__"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[4].source_labels[0] | string | `"__meta_kubernetes_namespace"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[4].target_label | string | `"namespace"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[5].source_labels[0] | string | `"__meta_kubernetes_pod_name"` |  |
| metrics.prometheus.additionalScrapeConfigs[2].relabel_configs[5].target_label | string | `"pod"` |  |
...
| metrics.scrapeKubeStateMetrics | bool | `false` |  |
