...
class BaseServiceManager:
    ...
    def _get_service_manager_class(kind: str) -> Type["BaseServiceManager"]:
        ...
        elif kind.lower() in [k.lower() for k in CustomServiceManager.SUPPORTED_KINDS]:
    ...
    def discover_services_static(namespace: str, name_filter: str = None) -> List[Dict]:
        ...
        def fetch_custom_resources():
            ...
            local_services = []
            for resource_kind in CustomServiceManager.SUPPORTED_KINDS:
                config = CustomServiceManager._get_config(resource_kind)
