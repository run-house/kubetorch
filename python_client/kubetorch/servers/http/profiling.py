...
def run_with_profile(
    ...
    **kwargs,
    ...
    if profiler_type not in SUPPORTED_PROFILERS:
        logger.info("in profiler_type not in SUPPORTED_PROFILERS if clause")
    ...
    if profiler_type == "torch":
        ...
        if output_format == "chrometrace":
            ...
            profiler_output = pickle.dumps(profiler_output)
